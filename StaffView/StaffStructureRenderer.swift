...
//    public init(model: StaffModel, configuration: ) {
//        self.model = model
...
//        
//        // TODO: Refactor
//        let clefLayer = CALayer(clefView.rendered)
//        context.addSublayer(clefLayer)
//    }
//    
////    private func clef(configuration: StaffStructureConfiguration) -> StaffClefView {
...
////    ) -> StaffClefView
////    {
////        let position = VerticalAxisPosition(x: x, plotTop: staffTop, plotBottom: 8 * staffSlotHeight)
////        let configuration = ClefConfiguration(foregroundColor: foregroundColor, maskColor: maskColor)
////        return kind.view.init(position: position, configuration: configuration)
////    }
////
